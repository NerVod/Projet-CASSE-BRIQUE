...
{
	gameMessage ("Casse-briques", "Petit jeu de raquette simple, minimaliste, servant de support de formation au développement JavaScript et jQuery", "Cliquez pour lancer une partie", startGame, 'images/logo_NerVod.png');
}
...
function chooseExtraType()
{
	...
	{
		type = 'R'; // Réduction de la taille de la raquette
	}
	else if (chance < .80)
	{
...
function showGameOver()
{
	...
	gameMessage ("Game Over !!!", "La partie est terminée. Vous avez marqué " + playerScore + ' points.' + extraMessage, "Retourner à l'accueil", restartGame, 'images/logo_NerVod.png');
}
